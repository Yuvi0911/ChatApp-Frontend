...
const FileMenu = ({anchorE1, chatId}) => {
  ...
  //   ref.current?.click();
  // }
  // <MenuItem onClick={()=>selectRef(imageRef)}> is line me hum isme onClick={()=>selectRef(imageRef)} directly function de dege onClick={slectImage}
  ...
  const fileChangeHandler = async(e, key) => {
    ...
    try {
      ...
      const res = await sendAttachments(
        myForm
      );
