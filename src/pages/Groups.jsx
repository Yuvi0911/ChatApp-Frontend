...
const Groups = () => {
  ...
  if(chatId){
    ...
    // ye ek clean up function h jo ki dobara useEffect call hone se phle resources ko clean up krdega
    return ()=>{
      setGroupName("");
      setGroupNameUpdatedValue("");
      setIsEdit(false)
  ...
  >
    <Button color="error" startIcon={<DeleteIcon/>} onClick={openConfirmDeleteHandler}>Delete Group</Button>
